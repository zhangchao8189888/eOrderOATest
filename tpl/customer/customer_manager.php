...
<script language="javascript" type="text/javascript">
    $(function(){
        ...
        $(".zhidan").change(function (){
            var id = $(this).attr("data-id");
            $.ajax(
                {
                    type: "POST",
                    url: "index.php?action=Customer&mode=updateZhidan",
                    async:false,
                    data: {
                        id: id,
                        value: $(this).val()
            ...
            <div class="span12"><div class="widget-box">
                    <div class="widget-title">
                        <ul class="nav nav-pills">
                            <li class=""><a href="index.php?action=Customer&mode=getCustomerList&n=3_1">客户列表</a></li>
                            <li class="active"><a href="index.php?action=Customer&mode=getJingbanrenlist&n=3_2">客户经理</a></li>
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                while ($row = mysql_fetch_array($jingbanList)){
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="tr">
                                            <select  class="zhidan" data-id="<?php echo $row['id'];?>"  <?php if($this->access_name != "modify") {  echo "disabled" ;}?> >
                                                <option <?php if ($row['is_zhidan_type'] == 0) echo "selected";?> value="0">否</option>
                                                <option <?php if ($row['is_zhidan_type'] == 1) echo "selected";?> value="1">是</option>
                                            </select>
                                        </td>
                                        <td class="tr">
                                            <?php if($this->access_name == "modify") {

            ...
            <div class="span12"><div class="widget-box">
                    <div class="widget-title">
                        <ul class="nav nav-pills">
                            ...
                            <li class="active"><a href="index.php?action=Customer&mode=toAddCustomerLevel&n=3_3" >客户级别设置</a></li>
                        </ul>
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                while ($row = mysql_fetch_array($levelList)){
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="tl pl10"><?php echo $row['content'];?></td>

                                        <td class="tr">
                                            <?php if(0 && $this->access_name == "modify") {
                                                ?>
                                                <a title="删除" href="#" class="btn btn-success btn-small delLevel" data-id="<?php echo $row['id'];?>">删除</a>
                                            <?php } ?>
                                            <!--<a title="修改" href="#" class="btn btn-success btn-small modifyLevel" data-id="<?php /*echo $row['id'];*/?>">修改</a>-->
                                        </td>
                                    </tr>
                                <?php }?>
                                </tbody>
...
<div class="modal hide" id="modal-event2">
    ...
    <div class="modal-body">
        <div class="designer_win">
            <div class="tips">级别名称：<input type="text" maxlength="20" id="levelName"  readonly></div>

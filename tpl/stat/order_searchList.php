            ...
            <div class="span12"><div class="widget-box">
                    <div class="widget-title">
                        <ul class="nav nav-pills">
                            <li class=""><a href="index.php?action=Stat&mode=toFinanceStat&n=2_4">财务统计</a></li>
                        </ul>
                    ...
                    <div class="widget-content tab-content ">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="order-sum clearfix">
                                <div class="order-sum-all">
                                    总金额： <span class="order-sum-money">￥<span class="order-sum-money-detail"><?echo $total['order_money'] ? $total['order_money'] : 0;?></span></span><span><?echo $total['order_num'];?>笔</span>
                                    <span class="order-sum-money">会员卡： ￥<span class="order-sum-money-detail"><?echo $total['vip_money'] ? $total['vip_money'] : 0;?></span></span>
                                    <span class="order-sum-money">现金：￥<span class="order-sum-money-detail"><?echo $total['cash_money'] ? $total['cash_money'] : 0;?></span></span>
                                    <span class="order-sum-money">赠送：￥<span class="order-sum-money-detail"><?echo $total['free_money'] ? $total['free_money'] : 0;?></span></span>
                                    <span class="order-sum-money">活动赠送：￥<span class="order-sum-money-detail"><?echo $total['huodong_money'] ? $total['huodong_money'] : 0;?></span></span>
                                    <span class="order-sum-money">微信：￥<span class="order-sum-money-detail"><?echo $total['weiChat_money'] ? $total['weiChat_money'] : 0;?></span></span>
                                    <span class="order-sum-money">支付宝：￥<span class="order-sum-money-detail"><?echo $total['aliPay_money'] ? $total['aliPay_money'] : 0;?></span></span>
                                    <span class="order-sum-money">赠送会员卡：￥<span class="order-sum-money-detail"><?echo $total['free_money'] ? $total['free_money'] : 0;?></span></span>
                                    <span class="order-sum-money">预收款：￥<span class="order-sum-money-detail"><?echo $total['yuShou_money'] ? $total['yuShou_money'] : 0;?></span></span>
                                    <span class="order-sum-money">充值：￥<span class="order-sum-money-detail"><?echo $total['recharge_money'] ? $total['recharge_money'] : 0;?></span></span>
                                    <span class="order-sum-money">转银行卡：￥<span class="order-sum-money-detail"><?echo $total['toCard_money'] ? $total['toCard_money'] : 0;?></span></span>
                                    <span class="order-sum-money">转账：￥<span class="order-sum-money-detail"><?echo $total['zhuan_money'] ? $total['zhuan_money'] : 0;?></span></span>
                                </div>
                            </div>
                            <div class="order-sum clearfix">
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                foreach ($orderList as $row){
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="td-text-right">
                                            <div class="orange"><?php echo $row['level_name'];?></div>
                                        </td>

                                        <td class="td-text-right">
                                            <div class="orange"><?php echo $row['pay_type_name'];?></div>
                                        </td>
                                ...
                                foreach ($returnList as $returnRow){
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="td-text-right">
                                            <div class="orange"><?php echo $returnRow['level_name'];?></div>
                                        </td>
                                        <td class="td-text-right">

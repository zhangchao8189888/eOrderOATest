...
<script src="common/common-js/stat_product.js?4"></script>
<div id="content">
            ...
            <div class="span12"><div class="widget-box">
                    <div class="widget-title">
                        <ul class="nav nav-pills">
                            <li class="active"><a href="index.php?action=Stat&mode=toProductStat">按商品统计</a></li>
                            <li class=""><a href="index.php?action=Stat&mode=toCustomerStat">按客户统计</a></li>
                            <li class="active"><a href="index.php?action=Stat&mode=toCustomerOrderStat">按客户订单统计</a></li>
                        </ul>

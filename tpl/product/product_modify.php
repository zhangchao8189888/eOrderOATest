                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="product_type" id="product_type">
                                        <option value="1" <?php if($productPo['pro_type'] ==1) echo 'selected';?>>法国</option>
                                        <option value="2" <?php if($productPo['pro_type'] ==2) echo 'selected';?>>其它国家</option>
                                        <option value="3" <?php if($productPo['pro_type'] ==3) echo 'selected';?>>香槟</option>
                                        <option value="4" <?php if($productPo['pro_type'] ==4) echo 'selected';?>>起泡酒</option>
                                        <option value="5" <?php if($productPo['pro_type'] ==5) echo 'selected';?>>白酒和威士忌</option>
                                        <option></option>
                                    </select>
                                   </div>
                            </div>

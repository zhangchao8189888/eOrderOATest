                        ...
                        <div class="tab-pane active" id="tab1">
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="tl"><div>原产地</div></th>
                                    <th class="tl"><div>商品级别</div></th>
                                ...
                                while ($row=mysql_fetch_array($proList) ){
                                    ...
                                    <tr >
                                        ...
                                        <td><div><a href="index.php?action=Product&mode=getProduct&pid=<?php  echo $row['id'];?>" target="_self"><?php if (!empty($row['pro_name'])) echo $row['pro_name']; else echo '<span style="color: red">无编号</span>';?></a></div></td>
                                        <td><div><?php echo $row['pro_address'];?></div></td>
                                        <td><div><?php echo $row['pro_level'];?></div></td>
                                        <td><div><?php echo $productType[$row['pro_type']];?></div></td>

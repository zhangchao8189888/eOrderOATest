...
<script src="common/common-js/storage.js?4"></script>
<div id="content">
                ...
                <div class="widget-box">
                    <div class="widget-title">
                        <ul class="nav nav-pills">
                            ...
                            <li class="active"><a href="index.php?action=Product&mode=toIntoStorage&n=4_3">商品入库</a></li>
                    ...
                    <div class="widget-content nopadding">
                        <form id="salForm" action="" method="post">
                            <div class="form-horizontal form-alert">
                                ...
                                <label class="control-label"><em class="red-star">*</em>生产日期：</label>
                                <div class="controls">
                                    <input type="text" id="produce_date" name="produce_date" value="<?php echo date("Y-m-d");?>"  onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd',realDateFmt:'yyyy-MM-dd'})"/>

                    ...
                    <div class="widget-content tab-content ">
                        <div class="actions">
                            ...
                            <div class="accordion-body collapse" id="collapseGTwo" style="height: 0px;">
                                <form action="index.php?action=Product&mode=getProductNumList" method="post">
                                    ...
                                    <span class="pull-left">
                                        ...
                                        <div class="controls">
                                            <select name="pro_type">
                                                ...
                                                <option value="2">其它国家</option>
                                                <option value="3">香槟</option>
                                                <option value="4">起泡酒</option>
                                                <option value="5">白酒和威士忌</option>
                                                <option></option>
                                            </select>
                        ...
                        <div class="tab-pane active" id="tab1">
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                foreach ($proNumList as $row){
                                    ?>
                                    <tr class="">
                                        <td class="tl pl10"><?php echo $productType[$row['pro_type']];?></td>
                                        <!--<td class="tl pl10">

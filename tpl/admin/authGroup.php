<?php
$authGroupList=$form_data['groupList'];
$count=$form_data['count'];
global $menus;
?>
<script>
    var menu_list = <?php echo json_encode($menus);?>;
</script>
<div id="content">
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <?php }else {  foreach ($authGroupList as $k => $row){?>
                        <tr >
                            ...
                            <td><div><?php echo $row['describes'];?></div></td>
    ...
    <div class="modal-body">
        <form id="group_form_add">
            <div class="form-horizontal form-alert">
                ...
                <div class="control-group">
                    ...
                    <div class="controls" id="rule_checkbox">
                        <?php foreach ($menus as $k=>$v) { ?>
                            <input type="checkbox" name="rule_add" data-val="rule" class="rule_add" value="<?php echo $k; ?>"><?php echo $v['resource']; ?>
                        <?php }?>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    <div class="form-horizontal form-alert" id="access_add" style="display: none">
    ...
    <div class="modal-body">
        <form id="group_form_edit">
            <div class="form-horizontal form-alert">
                ...
                <div class="control-group">
                    <div class="form-horizontal form-alert" id="access_up" style="display: none">
                        <table border="1" borderColor="grey" cellpadding="5" width="98%" id="check">
                            <tr>
                                <td>菜单名称</td>
                                <td>子菜单</td>
...
<script src="common/common-js/zq.group.js" type="text/javascript"></script>

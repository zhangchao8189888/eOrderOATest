            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="form-actions">
                        ...
                        <a id="cancel" class="btn"  href="index.php?action=Order&mode=getOrderById&orderId=<?php echo $orderTotal['order_no'];?>">取消<a/>

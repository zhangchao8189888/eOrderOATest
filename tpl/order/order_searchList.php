            ...
            <div class="span12"><div class="widget-box">
                    <div class="widget-title">
                        <ul class="nav nav-pills">
                            ...
                            <li class="active"><a href="index.php?action=Order&mode=toOrderStatistics&n=2_3">订单商品统计</a></li>
                            <li class=""><a href="index.php?action=Order&mode=toFinanceStat&n=2_4">财务统计</a></li>
                        </ul>

                ...
                <div class="widget-box">
                        ...
                        <div class="search-form">
                            ...
                            <div class="row-fluid1">
                                <div class="search">
                                    ...
                                    <input type="hidden" id="orderReturn" name="orderReturn" value="1">
                    ...
                    <div class="widget-content tab-content">
                        ...
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="control-group remark">
                                <label class="control-label">退款信息：</label>
                                <div class="control-input">
                                    <div style="display: none" class="return-input refund-info">
                                        <input type="hidden" value="1" id="isReturn"/>
                                        <!--<a title="编辑" id="refund-edit" class="ui-op ui-op-edit" href="javascript:void(0)">编辑</a>-->
                                        联系人：<span class="contact"></span>
                                        联系电话：<span class="mobile"></span>
                                        <!--开户银行：<span class="bank"></span>
                                        开户名称：<span class="bankName"></span>
                                        银行账号：<span class="bankAccount"></span>-->
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <input id="returnSubmit" class="btn btn-primary" type="submit" value="提交">
...
<script language="javascript" type="text/javascript" src="common/order/order.js?13" charset="utf-8"></script>
<script language="javascript" type="text/javascript" src="common/order/orderAdd.js" charset="utf-8"></script>
<script language="javascript" type="text/javascript" src="common/order/orderReturn.js" charset="utf-8"></script>
